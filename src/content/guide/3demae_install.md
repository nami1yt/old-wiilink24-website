...
4. Type the command `/dominos` in the chat, placing your **Console ID** that you got from the **Get Console ID** homebrew app, in the parameter box, otherwise the command will not work and will be posted publicly on the channel.
    ...
    ![imgcaroussel](/Images/guide/consoleID.png)
...
![imgcaroussel](/Images/guide/spd-1.png)
![imgcaroussel](/Images/guide/spd-2.png)
...
![img2](/Images/guide/success.png)<br><br>
...
![img2](/Images/guide/country-setup.png)<br><br>
...
![img2](/Images/guide/order.png)<br><br>
